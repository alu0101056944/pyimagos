...
class ExpectedContourMedialPhalanx(ExpectedContourOfBranch):
  ...
  def shape_restrictions(self, criteria: dict = None,
    ...
    if not decompose:
      ...
      if self._aspect_ratio < criteria['medial']['aspect_ratio_min']:
        return float('inf')
      
      if self._aspect_ratio > criteria['medial']['aspect_ratio_max']:
        return float('inf')
      ...
      difference = difference + (
        criteria['medial']['positional_penalization'] * (
      ...
      threshold_value = criteria['medial']['aspect_ratio_min']
      ...
      threshold_value = criteria['medial']['aspect_ratio_max']

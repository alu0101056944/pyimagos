...
def show_contours_position_restrictions(contours, contour_id,
  ...
  rect = cv.minAreaRect(contours[contour_id])
  bounding_rect_contour = cv.boxPoints(rect)
  bounding_rect_contour = np.int32(bounding_rect_contour) # to int
  cv.drawContours(minimal_image, [bounding_rect_contour], 0, (0, 255, 0),
                  1)
...
np.array([[[ 98,  35]],
  ...
  expected_contour = ExpectedContourProximalPhalanx(1)
  show_contours_position_restrictions(
    contours,
    1,
    expected_contour,
  ...
  expected_contour = ExpectedContourProximalPhalanx(5)
  show_contours_position_restrictions(
    contours,
    2,
    expected_contour,
